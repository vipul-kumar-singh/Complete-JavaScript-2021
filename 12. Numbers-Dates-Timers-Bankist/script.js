...
console.log(Number.parseInt('1111', 10));
...
//toFixed -> Returns string value upto specified decimal places
...
console.log(future.getTime()); // convert date as millis
console.log(new Date(2142237180000)); // convert millis to date
